<?php
/**
 * The template for displaying archive imobil page.
 *
...
<div class="mainContent">
    <div class="container blog-content-archive">
        <h1 class="main-blog-heading"><?php _e('Blog', 'jhfw'); ?></h1>
        <?php if (have_posts()) : ?>
                        ...
                        <div class="article-block">
                            <div class="col-sm-12 blog-image">
                                <?php if (has_post_thumbnail()) {
                                    ...
                                    $default_blog_image = get_template_directory_uri() . '/images/default-img.png'; ?>
